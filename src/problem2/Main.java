...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("polymorphically computed sum of all Staff and Teacher salaries is: " + salarySum);
		
	}
	
	//IMPLEMENT
	public static List<EmployeeData> combine(List<Staff> staff, List<Teacher> teachers) {
		List<EmployeeData> Eplist=new ArrayList<>();
		Eplist.addAll(staff);
		Eplist.addAll(teachers);
		
		return new ArrayList<EmployeeData>(Eplist);
	}
